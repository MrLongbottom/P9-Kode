...
def lm_evaluate_word_doc(word: str, doc, doc_id):
    """
    Language model evaluate the probability for a given word in a document
    Formula is based on the Topic level random walk article
    :param word: the given word
    :param doc: the document
    :param doc_id: the document id
    :return: a probability of the word being in the document
    """
...
def lm_evaluate_query_doc(query: List[str], document_index: int):
    """
    Calculates the probability of a given query being generated by a document
    :param query: the query
    :param document_index: document index
...
def lm_evaluate_query(query_index, query_words, tell=False):
    """
    Calculates the probability for the given query taken from a specific document
    in every document and prints out the 3 documents with the highest probability
    and what the index of the real document is
    :param query_index: the index of the real document for the query
    :param query_words: the query
    :param tell: shall it print out the top 3
    :return: the sorted list of document indexes based on the query.
    """
    lst = {}
