...
doc2word = utility.load_vector_file("Generated Files/res_doc2word.csv")
word2vec = utility.load_vector_file("Generated Files/res_word2vec.csv")
...
if __name__ == '__main__':
    ...
    # Loading matrices
    cv_matrix = sp.load_npz("Generated Files/res_count_vec_matrix.npz")
    dt_matrix = sp.load_npz("Generated Files/res_topic_doc_matrix.npz")
    ...
    t_queries1 = generate_document_queries(cv_matrix, word2vec, 80, min_length=1, max_length=1)
    t_queries2 = generate_document_queries(cv_matrix, word2vec, 80, min_length=2, max_length=2)
    t_queries3 = generate_document_queries(cv_matrix, word2vec, 80, min_length=3, max_length=3)
    t_queries4 = generate_document_queries(cv_matrix, word2vec, 80, min_length=4, max_length=4)

    print(str(check_valid_queries(t_queries1)))
    print(str(check_valid_queries(t_queries2)))
    print(str(check_valid_queries(t_queries3)))
    print(str(check_valid_queries(t_queries4)))
